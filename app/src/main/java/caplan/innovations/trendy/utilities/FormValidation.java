...
public final class FormValidation {
    ...
    public static boolean isFieldValid(String field, int minLength, int maxLength,
        ...
        if (FormValidation.isEmpty(field)) {
            textInputLayout.setError(TrendyApplication.context().getString(R.string.error_required));
            return false;
        } else if (FormValidation.isTooShort(minLength, field)) {
            textInputLayout.setError(TrendyApplication.context().getString(R.string.error_too_short));
            return false;
        } else if (FormValidation.isTooLong(maxLength, field)) {
            textInputLayout.setError(TrendyApplication.context().getString(R.string.error_too_long));
            return false;
        } else {
